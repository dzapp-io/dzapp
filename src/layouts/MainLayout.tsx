...
export const Header: FC = ({ children }) => {
  return (
    <header className="p-4 md:py-6 bg-gray-900/80 text-gray-300 w-full border-b-2 border-purple-500 sticky top-0">
...
export const Footer = () => (
  <footer className="flex items-center w-full h-24 border-t-2 border-purple-500 bg-gray-900/80 text-purple-200">
